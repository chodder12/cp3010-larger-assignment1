...
app.post('/api/review',upload.single('movie_poster'), async (req, res) => {
    ...
    const insertOperation = await db.collection('movies').insertOne({'title':req.body.title,'actors':req.body.actors,'release':req.body.release,'rating':req.body.rating, 'poster':req.file.filename});
